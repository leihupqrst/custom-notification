...
public class ArcProgressView extends AppCompatTextView {
     ...
     * 圆弧的宽度
     */
    private float borderWidth = dipToPx(1.5f);
    /**
     * 画步数的数值的字体大小
     */
    ...
    private float marginHeight = 30;

    private String stepNumberLeft = "10000";

    private int stepTextSize = 40;
...
//
//        drawTextStepLeftString(canvas, centerX);
    }
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(android.R.color.white));//设置画笔颜色
...
//        stepNumberLeft = String.valueOf(10000 - currentCounts);
